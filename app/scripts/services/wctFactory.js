...
(function () {
  ...
  angular.module('WctApp').factory('projectFactory', projectFactory);
  angular.module('WctApp').factory('consultantFactory', consultantFactory);
  angular.module('WctApp').factory('clientFactory', clientFactory);
  angular.module('WctApp').factory('echosignFactory', echosignFactory);
